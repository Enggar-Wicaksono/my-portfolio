    ...
    <div className="hero grid md:grid-cols-2 items-center pt-10 xl:gap-0 gap-6 grid-cols-1">
      <div className="animate__animated animate__fadeInLeft animate__delay-3s">
        ...
        <div className="flex items-center sm:gap-4 gap-2">
          <a href="https://drive.google.com/uc?export=download&id=14JxT67UGhMX2foedqOtcyH6HWQaW4Nwk" className="bg-violet-700 p-4 rounded-2xl hover:bg-violet-600">Download <i className="ri-download-line ri-lg"></i></a> 
